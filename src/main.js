...
const myBot = ['u8996c744f260a1bb693578eb00ab52c4','u236b88bf1eac2b90e848a6198152e647'];
...
class LINE extends LineAPI {
    ...
    searchReader(seq) {
        ...
        if(myBot.includes('u8996c744f260a1bb693578eb00ab52c4')) {
    ...
    async textMessage(txt, seq) {
        ...
        if(txt == 'Bot' || txt == 'cyber') {
            this._sendMessage(seq, 'Toif Bots in hare :)');
        }
        ...
        if(txt === 'Bom' && this.stateStatus.kick == 1) {
        ...
        if(txt == 'Bakekok'){
            ...
            let xz = rec.split(',');
            this._sendMessage(seq, `== Bakekok Sider ==\n${xz.join('\n')}`);
